...
if ( get_theme_mod( 'rosewood_hide_related_posts', false ) ) return;
...
if ( $related_posts ) : ?>
	...
	<div class="section-inner wide">
		...
		<div class="related-posts">
			...
			<h3 class="related-posts-title"><?php _e( 'Related Posts', 'rosewood' ); ?></h3>
			...
			foreach ( $related_posts as $post ) {
				...
				if ( has_post_thumbnail() ) {
					$image = wp_get_attachment_image_src( get_post_thumbnail_id(), 'rosewood_preview-image' );
