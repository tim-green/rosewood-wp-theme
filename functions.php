...
$theme_version = '1.0.1';
	...
	function themes_starter_scripts_loader() {
		...
		wp_enqueue_style( 'main', get_template_directory_uri() . '/build/app.min.css', false, $theme_version, 'all' ); // main.scss: Compiled Framework source + custom styles
		...
		wp_enqueue_script( 'mainjs', get_template_directory_uri() . '/build/app.min.js', false, $theme_version, true );
